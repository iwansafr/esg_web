		...
		<figure class="figure">
			...
			if(!empty($data))
			{
				...
				foreach ($data as $key => $value) 
				{
					...
					?>
					<img src="<?php echo image_module('content', 'gallery'.'/'.$content['id'].'/'.$value);?>"  data-toggle="modal" data-target="#img-<?php echo $i;?>" class="" style="object-fit: cover;width: 100px;height: 100px; margin: 5px;">
					<!-- Modal -->
